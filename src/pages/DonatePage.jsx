      ...
      <div className="w-full max-w-md absolute left-1/2 transform -translate-x-1/2">
        <div className="bg-black text-white p-6 rounded-lg shadow-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block mb-2 text-sm font-semibold">Masukkan Nominal Donasi</label>
              <div className="grid grid-cols-3 gap-2 text-black">
                {[{ value: "10000", label: "😊 Rp10.000" }, { value: "25000", label: "😍 Rp25.000" }, { value: "50000", label: "🥰 Rp50.000" }].map(({ value, label }) => (
                  <button
                    key={value}
                    type="button"
            ...
            <div>
              <label htmlFor="customAmount" className="block mb-2 text-sm font-semibold">
              ...
              />
              <p className="text-xs text-gray-400 mt-1">Minimal donasi sebesar Rp10.000</p>
            </div>
