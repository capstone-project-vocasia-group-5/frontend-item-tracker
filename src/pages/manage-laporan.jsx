    ...
    <div>
      <div className="min-h-screen flex flex-col">
        <div className="md:p-4">
          <header className="bg-white shadow-sm p-4 text-left justify-between">
            <h1 className="text-xl font-bold my-2">Manajemen Laporan</h1>
            <p className="text-gray-400">
              Pantau laporan Anda terkait barang hilang atau temuan yang telah
              Anda laporkan, dan tunggu persetujuan dari admin.
            </p>
          </header>
              ...
              <table className="w-full bg-white table-fixed rounded-md">
                <thead className="bg-black text-white">
                  <tr>
                    ...
                    <th className="p-4 text-center hidden md:block">Status</th>
        ...
        {selectedItem && popupType === "detail" && (
          <Popup
            ...
            item={{
              ...
              status_report: true,
              matched_status: selectedItem.matched_status,
