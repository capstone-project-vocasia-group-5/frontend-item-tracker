...
export const Footer = () => {
  return (
    <footer class="flex relative bottom-0 w-full p-4 bg-primaryBlack border-t border-gray-200 shadow md:flex md:items-center md:justify-between md:p-6 dark:bg-gray-800 dark:border-gray-600">
